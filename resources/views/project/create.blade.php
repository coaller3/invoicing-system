                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="rate" step="0.01" onchange="setThreeNumberDecimal" required>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Total Hours <b style="color: red;">*</b></label>
                                        <input type="number" class="form-control" name="duration" step="0.5" min="0.5" onchange="setThreeNumberDecimal" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
